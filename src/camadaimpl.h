...
public:
  ...
  SMTExprRef mkBVNeg(const SMTExprRef &Exp) final { return mkBVNegImpl(Exp); }

  SMTExprRef mkBVNot(const SMTExprRef &Exp) final { return mkBVNotImpl(Exp); }
  ...
  SMTExprRef mkNot(const SMTExprRef &Exp) final { return mkNotImpl(Exp); }
  ...
  bool getBool(const SMTExprRef &Exp) final { return getBoolImpl(Exp); }

  int64_t getBV(const SMTExprRef &Exp) final { return getBVImpl(Exp); }
  ...
  float getFP32(const SMTExprRef &Exp) final { return getFP32Impl(Exp); }

  double getFP64(const SMTExprRef &Exp) final { return getFP64Impl(Exp); }
