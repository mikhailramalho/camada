...
# ``install_manifest.txt``). See also
# https://gitlab.kitware.com/cmake/community/wikis/FAQ#can-i-do-make-uninstall-with-cmake
#
# The :module:`AddUninstallTarget` module must be included in your main
# ``CMakeLists.txt``. If included in a subdirectory it does nothing. This allows
# you to use it safely in your main ``CMakeLists.txt`` and include your project
# using ``add_subdirectory`` (for example when using it with
# :cmake:module:`FetchContent`).
#
# If the ``uninstall`` target already exists, the module does nothing.

# =============================================================================
# Copyright 2008-2013 Kitware, Inc. Copyright 2013 Istituto Italiano di
# Tecnologia (IIT) Authors: Daniele E. Domenichelli
